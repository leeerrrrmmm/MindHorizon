      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
            ...
            // Первый выбор
            _buildSelectableCircle(0, "I want to improve my sleep", 209, 86),
            ...
            // Второй выбор
            _buildSelectableCircle(1, "I need to relieve stress", 383, 14),
            // БОКОВОЙ ЕЛЕМЕНТ
            Positioned(
              bottom: -50,
              right: 0,
            ...
            // Третий выбор
            _buildSelectableCircle(2, "I want to improve my sleep", 554, 21),
          ],
        ),
      ),
    );
