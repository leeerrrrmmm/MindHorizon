...
/**
 * !
 * ! исправить навигацию при удалении аккаунта(вместо Login -> Onboarding)
 * ! при выходе вместо Onboarding -> Login
 * ! возможно сделать отдельный скрин для елементов,в которых нужно только 1 ассет
 * ! длинный прослушать
 */
